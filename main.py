...
if __name__ == '__main__':
    ...
    # run_simulation_threads_v3(100, 100, 2)
    run_simulation_threads_v3(100, 10000, 20)
    run_simulation_threads_v3(150, 10000, 20)
    run_simulation_threads_v3(200, 10000, 20)
    run_simulation_threads_v3(250, 10000, 20)
    run_simulation_threads_v3(300, 10000, 20)
#
